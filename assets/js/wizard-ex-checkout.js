...
$(function () {
  ...
  let totalPrice = 0;
  //ajax call
  $.getJSON("/assets/json/cart.json") //from database in
    .then(function (data) {
      products = data.data;
          ...
          products.forEach(function (product) {
            ...
            productSpan.innerHTML = `<div class="d-flex gap-3">
              <div class="flex-shrink-0">
                  <img src="../../assets/img/products/${Aproduct.image[0]}"
                      alt="${Aproduct.image[0]}" class="w-px-100" />
              </div>
                      ...
                      <div class="col-md-8">
                          <h6 class="me-3">
                              <a href="javascript:void(0)"
                                  class="text-body">${Aproduct.name} (${Aproduct.version})</a>
                          </h6>
                          <div class="text-muted mb-1 d-flex flex-wrap">
                              <span class="me-1">Sold by:</span>
                              <a href="javascript:void(0)"
                                  class="me-1">${Aproduct.origin}</a>
                      ...
                      <div class="col-md-4">
                          <div class="text-md-end">
                              ...
                              <div class="my-2 my-md-4">
                                  <span
                                      class="text-primary price-product">${Aproduct.price.toLocaleString('vi-VN')} VNĐ</span>
                              </div>
                          </div>
                      </div>
                  </div>
            ...
            productSpan.innerHTML = `
                <div class="d-flex gap-3">
                  <div class="flex-shrink-0">
                      <img src="../../assets/img/products/${Aproduct.image[0]}"
                          alt="${Aproduct.name}" class="w-px-75" />
                  </div>
                  <div class="flex-grow-1">
                      <div class="row">
                          <div class="col-md-8">
                              <a href="javascript:void(0)" class="text-body">
                                  <h6>${Aproduct.name} (${Aproduct.version})</h6>
                              </a>
                              <div class="text-muted mb-1 d-flex flex-wrap">
                                  <span class="me-1">Sold by:</span>
                                  <a href="javascript:void(0)"
                          ...
                          <div class="col-md-4">
                              <div class="text-md-end">
                                  <div class="my-2 my-lg-4">
                                      <span
                                          class="text-primary">${Aproduct.price.toLocaleString('vi-VN')} VNĐ</span><s
                                  </div>
                              </div>
                          </div>
                      </div>
            ...
            totalPrice += parseInt(Aproduct.price);
